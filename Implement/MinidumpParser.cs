...
namespace RTTIScanner.Implement
{
    public class MinidumpParser
    {
        ...
        public byte[] ReadMemoryFromVS(IntPtr pointer, int size)
        {
            ...
            {
                RTTIScannerImpl.ErrorResult("获取栈帧失败!");
                return null;
            }
            ...
            {
                RTTIScannerImpl.ErrorResult("获取IDebugExpressionContext2失败!");
                return null;
            }
            ...
            {
                RTTIScannerImpl.ErrorResult("获取IDebugExpression2失败!");
                return null;
            }
            ...
            {
                RTTIScannerImpl.ErrorResult("获取IDebugProperty2失败!");
                return null;
            }
            ...
            {
                RTTIScannerImpl.ErrorResult("获取IDebugMemoryContext2失败!");
                return null;
            }

            if (DebuggerIfaces.Instance.program == null)
            {
                RTTIScannerImpl.ErrorResult("获取program失败!");
                return null;
            }
            ...
            {
                RTTIScannerImpl.ErrorResult("获取IDebugMemoryBytes2失败!");
                return null;
            }
            ...
            {
                RTTIScannerImpl.ErrorResult("从VS读取内存失败!");
                return null;
            }
